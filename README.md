...
цель:
Создать полнофункциональную командную оболочку на языке C с поддержкой современных возможностей Unix/Linux shell.
...
Результат
Создана полноценная командная оболочка с поддержкой всех основных функций современных shell, включая управление задачами, перенаправления, конвейеры и встроенные команды. Система демонстрирует принципы работы операционных систем, управления процессами и синтаксического анализа.
